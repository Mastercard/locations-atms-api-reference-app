...
package com.mastercard.locationsatmsreferenceapplication.config;

import com.mastercard.developer.interceptors.OkHttpOAuth1Interceptor;
import com.mastercard.developer.utils.AuthenticationUtils;
import com.mastercard.locationsatmsreferenceapplication.exception.LocationsAtmsServiceException;
import com.mastercard.locationsatmsreferenceapplication.services.DefaultLocationsAtmsReferenceService;
...
public class ApiClientConfiguration {
    ...
    public PrivateKey getSigningKey() {
        try {
            ...
            throw new LocationsAtmsServiceException(exception);
        }
    }
}
